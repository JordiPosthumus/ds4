...
template <uint32_t SORT_N>
__global__ static void candidate_topk_chunk_pow2_kernel(
        uint32_t *candidates,
        const float *scores,
        uint32_t n_comp,
        uint32_t n_tokens,
...
template <uint32_t SORT_N>
__global__ static void candidate_topk_merge_pow2_kernel(
        uint32_t *selected,
...
template <uint32_t SORT_N>
__global__ static void candidate_topk_tree_merge_pow2_kernel(
        uint32_t *out,
        const uint32_t *candidates,
        const float *scores,
        uint32_t n_comp,
