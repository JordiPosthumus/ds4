...
This fork uses one shared source branch across the Macs and Sparks. See
[local production configuration](LOCAL-PRODUCTION-CONFIG.md) for preserved
machine settings, deployment status, and validation requirements.
