...
#endif
static const int frontiers[] = {32, 512, 2048, 8192, 32768, 131072, CONTEXT-STEPS};
...
int main(int argc, char **argv) {
    check(argc == 5, "MODEL ENCODER CORPUS OUTPUT_DIRECTORY");
    ...
    free(reference);
    free(values);
    puts("PASS complete full-capacity stock/stack benchmark; production disk KV unused");
    return 0;
}
